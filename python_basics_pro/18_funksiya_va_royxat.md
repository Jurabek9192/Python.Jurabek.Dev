...
## Funksiya ichida ro'yxatni o'zgartirish — muhim tushuncha
...
Bu — sonlar (`int`) bilan farq qiladi, chunki `int` o'zgarmas (immutable):
...
7. Ismlar ro'yxatini qabul qilib, har birini katta harflarga aylantiruvchi funksiya yozing.
...
20. Rekursiv funksiya yozing — ro'yxatning yig'indisini rekursiya (funksiya o'zini o'zi chaqirishi) orqali hisoblang (`return royxat[0] + yigindi(royxat[1:])` mantig'ida).
